 ...
 */
public class ClockFaceTimePickerView extends View {
	...
	public ClockFaceTimePickerView(Context context) {
		super(context);
		init(null, 0);
	}

	public ClockFaceTimePickerView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.ClockFaceTimePickerView, defStyle, 0);

		mExampleString = a
				.getString(R.styleable.ClockFaceTimePickerView_exampleString);
		mExampleColor = a
				.getColor(R.styleable.ClockFaceTimePickerView_exampleColor,
						mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.ClockFaceTimePickerView_exampleDimension,
				mExampleDimension);

		if (a.hasValue(R.styleable.ClockFaceTimePickerView_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.ClockFaceTimePickerView_exampleDrawable);
